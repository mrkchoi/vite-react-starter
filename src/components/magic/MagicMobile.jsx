...
function Magic() {
  ...
  return (
    <section ref={section} className="magic">
      <div className="magic__content max-w-5xl pl-16 pr-16 pt-[7rem]">
        <div className="magic__contentPre mb-4 text-[1rem]">
          Magical experience
        </div>
        <h2 className="magic__contentTitle mb-8 text-[3.5rem]">
          Elaborately
          <br />
          simple.
        </h2>
        <p className="magic__contentText text-[1rem]">
      ...
      <div ref={sticky} className="magic__sticky top-[10vh] h-[75vh] flex-col">
        <div className="magic__stickyMain">
          <img
            ref={image01}
            src={img01}
        ...
        <div className="magic__stickySidebar left-0 p-16 text-[1rem]">
          <div ref={content01} className="magic__stickySidebarItem max-w-[70%]">
          ...
          <div ref={content02} className="magic__stickySidebarItem max-w-[70%]">
          ...
          <div ref={content03} className="magic__stickySidebarItem max-w-[70%]">
