...
function Engraving() {
  return (
    <div className="engraving mb-4">
      <div className="engraving__wrapper flex-col">
        <div className="engraving__contentWrapper">
          <div className="engraving__content w-full p-16">
            <div className="engraving__title text-[2rem]">
              Say it in a way
              <br />
              only you can.
            </div>
        ...
        <div className="engraving__media">
          <div className="engraving__mediaWrapper">
            <img
              ...
              className="engraving__img max-w-[75%]"
            />
          </div>
        </div>
      </div>
