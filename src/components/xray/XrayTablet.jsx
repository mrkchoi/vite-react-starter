      ...
      >
        <div className="xray__content max-w-5xl">
          ...
          <p className="xray__contentText text-[1.2rem] sm:max-w-[50%] sm:self-end lg:text-[1.5rem]">
            ...
            ultra-low distortion across the audible range. From deep, rich bass
            to accurate mids and crisp, clean highs, you'll hear every note with
            a new sense of clarity.
          </p>
        </div>
      </section>
      <section className="xrayImage__section h-[250vh] pt-[5rem] lg:pt-[10rem]">
        <div className="xrayImage__sticky top-0 h-[100vh] flex-col items-center">
          <div ref={imageWrapper} className="xrayImage__imgWrapper h-[70vh]">
            <img
              ref={mainImg01}
              src={main01}
              alt="airpods max"
              className="xrayImage__img xrayImage__main1 h-full w-auto overflow-visible object-cover"
            />
            <img
              ref={mainImg02}
              src={main02}
              alt="airpods max"
              className="xrayImage__img xrayImage__main2 h-full w-auto overflow-visible object-cover"
            />
            <img
              ref={driverImg01}
              src={driver01}
              alt="airpods max"
              className="xrayImage__img xrayImage__driver1 h-full w-auto overflow-visible object-cover"
            />
            <img
              ref={driverImg02}
              src={driver02}
              alt="airpods max"
              className="xrayImage__img xrayImage__driver2 h-full w-auto overflow-visible object-cover"
            />
          </div>
          <div className="xrayImage__contentSection w-full">
            <div
              ref={content01}
              className="xrayImage__content p-16 pt-8 text-[1.2rem]"
            >
