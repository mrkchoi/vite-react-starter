  ...
  return (
    <>
      ...
      <section className="xrayImage__section h-[250vh] pt-[5rem] lg:pt-[10rem]">
        <div className="xrayImage__sticky top-0 h-[95vh] flex-col">
          <div
            ref={imageWrapper}
            className="xrayImage__imgWrapper ml-[-30vw] h-[65vh]"
          >
            <img
              ref={mainImg01}
              src={main01}
          ...
          <div className="xrayImage__contentSection">
            <div
              ref={content01}
              className="xrayImage__content p-16 pt-8 text-[1rem]"
            >
