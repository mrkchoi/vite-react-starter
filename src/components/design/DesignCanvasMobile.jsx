...
function DesignCanvasMobile() {
  ...
  return (
    <div className="design__canvasSection">
      <div
        ref={canvasWrapper}
        className="design__canvasWrapper lg:max-w-3xl xl:max-w-4xl 2xl:max-w-5xl"
      >
        ...
        <div className="design__canvasContent">
          <div
            ref={content01}
            className="design__canvasContentText design__canvasContentText01"
          >
          ...
          <div
            ref={content02}
            className="design__canvasContentText design__canvasContentText02"
          >
          ...
          <div
            ref={content03}
            className="design__canvasContentText design__canvasContentText03"
          >
          ...
          <div
            ref={content04}
            className="design__canvasContentText design__canvasContentText04"
          >
...
export default DesignCanvasMobile;
