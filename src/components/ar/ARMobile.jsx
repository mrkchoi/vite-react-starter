...
function AR() {
  ...
  return (
    <div className="ar mb-[1rem]">
      <div className="ar__wrapper flex-col-reverse">
        <div className="ar__media items-center justify-center">
          <div className="ar__mediaWrapper max-w-[70%]">
            {IMAGES.map((img, idx) => (
              <img
                key={idx}
                src={img}
        ...
        <div className="ar__content p-16 pb-8">
          <div className="ar__contentWrapper">
            <img src={icon} alt="AR icon" className="ar__icon max-w-[2rem]" />
            <div className="ar__title mb-4 text-[2rem]">
              Use AR to see
              <br />
              AirPods Max.
            </div>
            <div className="ar__text max-w-[60%] text-[1rem]">
