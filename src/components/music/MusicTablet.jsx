    ...
    <section className="music mb-4">
      <div className="music__wrapper">
        ...
        <div className="music__contentWrapper flex-1">
          <div className="music__content p-16 pb-32 pl-0 pt-32">
            <svg
            ...
            <div className="music__title mb-8 max-w-[85%] text-[2.5rem]">
              Get 6 months of Apple Music free with your AirPods Max.
            </div>
            <a href="/" className="music__btn text-[1rem]">
              Learn more{" "}
              <svg
                viewBox="0 0 24 24"
                fill="none"
