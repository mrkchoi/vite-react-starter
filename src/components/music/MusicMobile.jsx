...
function Music() {
  return (
    <section className="music mb-4">
      <div className="music__wrapper flex-col-reverse">
        <div className="music__mediaWrapper pb-16">
          <div className="music__media basis-[60%]">
            <img
              src={img01}
              alt="apple music"
        ...
        <div className="music__contentWrapper">
          <div className="music__content p-16">
            <svg
              className="music__logo max-w-[100px]"
              viewBox="0 0 83 20"
              aria-hidden="true"
            >
            ...
            <div className="music__title mb-8 max-w-[75%] text-[2rem]">
