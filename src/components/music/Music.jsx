...
import img01 from "../../../public/assets/media/13_apple_music/762x762bb.jpg";
import img02 from "../../../public/assets/media/13_apple_music/music_album_stack__fkabj9dtjdui_large_2x.jpg";

function Music() {
  return (
    <section className="music mb-4 pl-32 pr-32">
      <div className="music__wrapper">
        <div className="music__mediaWrapper flex-1 items-center">
          <div className="music__media max-w-[50%] basis-[90%]">
            <img
              src={img01}
              alt="apple music"
              className="music__img music__img1"
            />
            <img
              src={img02}
              alt="apple music"
              className="music__img music__img2"
            />
          </div>
        </div>

        <div className="music__contentWrapper flex-1">
          <div className="music__content p-16 pb-48 pl-0 pt-48">
            <svg
              className="music__logo mb-4 max-w-[100px]"
              viewBox="0 0 83 20"
              aria-hidden="true"
            >
            ...
            <div className="music__title mb-8 max-w-[60%] text-[2.5rem]">
              Get 6 months of Apple Music free with your AirPods Max.
            </div>
            <a href="/" className="music__btn text-[1.2vw]">
              Learn more{" "}
              <svg
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="music__caret caret max-w-[1rem]"
              >
